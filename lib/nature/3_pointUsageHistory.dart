      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(' 2023-09-22', style: TextStyle(fontSize:18,fontWeight: FontWeight.bold,),),
            SizedBox(height:10,),
            buildStoryContainer(
              context,
            ...
            SizedBox(height:10,),
            Text(' 2023-09-21', style: TextStyle(fontSize:18,fontWeight: FontWeight.bold,),),
            SizedBox(height:10,),
            ...
            SizedBox(height:10,),
            Text(' 2023-09-20', style: TextStyle(fontSize:18,fontWeight: FontWeight.bold,),),
            SizedBox(height:10,),
...
Widget buildStoryContainer(BuildContext context, imageUrl, String title) {
  return InkWell(
    onTap: () {
